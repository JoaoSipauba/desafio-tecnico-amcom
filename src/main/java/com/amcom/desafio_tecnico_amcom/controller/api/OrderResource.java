...
public interface OrderResource {
    ...
    @ApiResponse(
            ...
            content = @Content(
                    ...
                    schema = @Schema(
                        implementation = ListOrdersResponse.class,
                        description = "Page containing ListOrdersResponse items"
                    )
            )
    )
    @GetMapping
    ...
    @ApiResponse(responseCode = "200", description = "Order found successfully", content = @Content(
            mediaType = "application/json",
            schema = @Schema(implementation = FindOrderResponse.class)
    ))
